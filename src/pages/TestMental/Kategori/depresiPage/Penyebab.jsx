...
const Penyebab = () => {
  ...
  <h1 className="text-2xl font-extrabold mt-10 mb-10 text-center px-8">Penyebab Depresi</h1>
  <div className='flex flex-wrap justify-center gap-14 px-10 max-lg:gap-5 '>
    <div className="grid justify-start gap-y-5">
      <p className="flex-shrink-0 bg-[#FFF] text-start p-2 rounded-lg min-w-[300px] font-bold text-slate-400 border border-current sm:min-w-max md:w-[400px]">✔ Stres Berkepanjangan</p>
      <p className="flex-shrink-0 bg-[#FFF] text-start p-2 rounded-lg min-w-[300px] font-bold text-slate-400 border border-current sm:min-w-max md:w-[400px]">✔ Ketidakmampuan Mengelola Emosi</p>
    ...
    <div className="grid justify-center gap-y-5">
      <p className="flex-shrink-0 bg-[#FFF] text-start p-2 rounded-lg min-w-[300px] font-bold text-slate-400 border border-current sm:min-w-max md:w-[400px]">✔ Kondisi Kesehatan fisik dan penyakit Lainnya</p>
