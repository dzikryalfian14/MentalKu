  ...
  return (
    <div className="p-16">
      <div className="text-center text-lg font-bold">
        Untuk mengetahui kondisi depresi, silahkan ikuti tes!!
      </div>
      <div className="flex justify-center">
        <button
          onClick={handleTestDepression}
      ...
      >
        <div className="content text-center">
          <p className="mb-4 text-lg">Apakah Anda yakin ingin melakukan tes depresi?</p>
          <div className="flex justify-center">
            <button
            ...
            <Link to="/tes-kesehatan-mental/depressiontest">
