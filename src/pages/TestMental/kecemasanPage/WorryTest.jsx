    ...
    <div className="bg-black self-stretch shrink-0 h-px mt-10 max-md:max-w-full" />
      {currentQuestionIndex < quizData.questions_kecemasan.length && (
        <div key={quizData.questions_kecemasan[currentQuestionIndex].id}>
          <p className="pt-4 pb-8 justify-center text-rose-400 text-justify text-4xl self-stretch mt-12 max-md:max-w-full max-md:mt-10">{quizData.questions_kecemasan[currentQuestionIndex].question}</p>
