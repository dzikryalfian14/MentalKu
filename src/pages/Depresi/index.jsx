        ...
        <div className="flex flex-col align-middle items-center lg:gap-12 justify-center p-10 lg:px-20 lg:flex-row">
          ...
          <div className="min-w-30 w-auto lg:max-w-[65%] text-center lg:text-justify">
            ...
            <p className="leading-loose text-center lg:text-justify text-lg md:text-[15px] lg:text-xl">
              Depresi adalah kondisi mental yang lebih serius daripada sekadar
              merasa sedih atau murung. Ini melibatkan perasaan sedih yang dalam
              dan menetap dalam jangka waktu yang lama, seringkali
              berbulan-bulan atau bertahun-tahun. Gejalanya meliputi kehilangan
              minat pada hal-hal yang biasanya dinikmati, perubahan berat badan
              atau nafsu makan, kesulitan tidur atau tidur terlalu banyak,
              perasaan putus asa, serta pikiran tentang kematian atau bunuh
              diri.
            </p>
          </div>
        </div>
      ...
      <div id="penyebab">
        <div className="flex flex-col items-center justify-center p-10 lg:px-20">
          ...
          <div className="flex flex-wrap gap-10 justify-center">
            ...
            <p className="bg-[#FFF] text-start p-2 rounded-lg font-medium text-slate-400 border border-current w-full md:w-1/2 lg:w-1/3">
              ✔ Kondisi Kesehatan fisik dan penyakit Lainnya
            </p>
            <p className="bg-[#FFF] text-start p-2 rounded-lg font-medium text-slate-400 border border-current w-full md:w-1/2 lg:w-1/3">
      ...
      <div id="tes">
        <div className="flex flex-col items-center justify-center p-10 lg:px-20">
          ...
          <div className="flex justify-center">
            <button onClick={handleTesDepresi}>
              <ButtonTemplate text="Tes Depresi" />
            </button>
          </div>
