        ...
        <div className="flex flex-col align-middle items-center lg:gap-12 justify-center p-10 lg:px-20 lg:flex-row">
          ...
          <div className="min-w-30 w-auto lg:max-w-[65%] text-center lg:text-justify">
            ...
            <p className="leading-loose text-center lg:text-justify text-lg md:text-[15px] lg:text-xl">
              Kecemasan adalah respons alami tubuh terhadap stres atau
              ketidakpastian. Ini bisa menjadi reaksi singkat terhadap situasi
              tertentu atau menjadi gangguan yang menetap dalam hidup
              sehari-hari seseorang. Kecemasan dapat terjadi dalam berbagai
              tingkatan, mulai dari yang ringan hingga yang parah. Gejalanya
              meliputi rasa gelisah, ketegangan, sulit berkonsentrasi, dan
              ketakutan yang berlebihan terhadap situasi tertentu.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center justify-center p-10 lg:px-20">
          ...
          <div className="flex justify-center">
            <button onClick={handleTesDepresi}>
              <ButtonTemplate text="Tes Kecemasan" />
            </button>
          </div>
