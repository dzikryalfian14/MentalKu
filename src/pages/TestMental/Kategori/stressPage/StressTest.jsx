...
const StressTest = () => {
  ...
  const handleNextQuestion = () => {
    ...
    if (currentQuestionIndex === quizData.questions_stress.length - 2) {
      setIsNext(`Submit`);
    }
        ...
        {currentQuestionIndex < quizData.questions_stress.length && (
          <div key={quizData.questions_stress[currentQuestionIndex].id}>
            <p className="typing-animation text-base sm:text-2xl xl:text-3xl pt-4 pb-8 text-left font-bold text-black self-stretch mt-10 max-md:max-w-full max-md:mt-10">
              {quizData.questions_stress[currentQuestionIndex].question}
            </p>
            {/* Opsi */}
            {quizData.questions_stress[currentQuestionIndex].options.map(
              (option, optionIndex) => (
                <button
                  key={optionIndex}
          ...
          <div className="bg-yellow-100">
            <div id="test-results">
              <div>
                ...
                <div className={stressDesign}>{stressCategory}</div>
