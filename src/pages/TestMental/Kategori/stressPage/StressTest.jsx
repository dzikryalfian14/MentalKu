...
const StressTest = () => {
  ...
  const downloadPdf = () => {
    ...
    html2canvas(element).then((canvas) => {
      ...
      pdf.save("hasil_test_stress.pdf");
    });
  };
  ...
  const calculateScore = () => {
    ...
    setStressCategory(stressCategory);
    const result = resultData.hasil_test.stres[stressCategory.toLowerCase()];
            ...
            <div key={quizData.questions_stress[currentQuestionIndex].id}>
              ...
              <div className="flex justify-between">
                ...
                >
                  {isNext}
                  {currentQuestionIndex ===
                  quizData.questions_stress.length - 1 ? null : (
                    <svg
                      className="w-4 h-4 text-white-800 dark:text-white"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div id="test-results">
                <div>
                  ...
                  <div className="text-base sm:text-2xl text-center xl:text-3xl pt-4 pb-8 font-bold text-black self-stretch mt-10 leading-10 -mr-5 max-md:max-w-full">
                    <span className={stressDesign}>{stressCategory}</span>
                  </div>
                  {/* Hasil Test */}
                  <p className="text-base sm:text-xl font-semibold text-center xl:text-3xl text-black self-stretch mt-5 leading-10 -mr-5 py-8 max-md:max-w-full">
                    {resultData.hasil_test.stres[stressCategory.toLowerCase()]}
                  </p>
